...
public class DBManager {
	...
	public Connection getConnection() throws SQLException {
		...
		try {
			...
			log.trace("initContext: " + initContext);
			log.trace("envContext: " + envContext);
			// ST4DB - the name of data source
			// DataSource ds = (DataSource)envContext.lookup("jdbc/ST4DB");
			DataSource ds = (DataSource)envContext.lookup("jdbc/b2");
...
/**************** THIS METHOD IS NOT USED IN THE PROJECT *******/
	...
	public Connection getConnectionWithDriverManager() throws SQLException {
        ...
        connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/st4db","root","dima");
