...
import ua.kharkov.khpi.belozerov.db.entity.Category;
import ua.kharkov.khpi.belozerov.db.entity.MenuItem;
import ua.kharkov.khpi.belozerov.db.entity.Order;

/**
 * Data access object for menu related entities.
 * (Объект доступа к данным (DAO) для объектов, связанных с меню.)
 */
public class MenuDao {
     ...
     * (Возвращает пункты меню данного заказа.)
     *
     ...
     * (Возвращает пункты меню с заданными идентификаторами.)
     *
