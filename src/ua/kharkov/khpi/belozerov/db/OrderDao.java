 ...
 * (Объект доступа к данным (DAO) для сущности Order и пользовательского компонента OrderBean.)
 */
public class OrderDao {
    ...
    private static final String SQL__GET_USER_ =
            "SELECT u.id, u.first_name, u.last_name, o.bill, s.name" +
